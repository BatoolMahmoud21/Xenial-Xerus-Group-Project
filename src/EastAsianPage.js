...
function EastAsianPage() {
  return (
    <div className="EastAsianPage">
      <header className="page-header">
        <button className="home-button" onClick={() => alert('Home clicked')}>
          Home
        </button>
        <h1>East Asian Populations</h1>
      </header>
      ...
      <div className="country-list">
        ...
        <p>
          China has been proactive in tackling this health issue, with government initiatives aimed at promoting healthy eating, physical activity, and early detection of diabetes. Additionally, ongoing genetic research plays a key role in identifying individuals at risk, facilitating more targeted prevention and treatment strategies for Type 2 diabetes.
        </p>
        ...
        <p>
          As with the Han Chinese, the genetic factors influencing T2D in the Japanese population are further compounded by environmental and lifestyle factors, such as high carbohydrate intake and a sedentary lifestyle. However, Japan has seen improvements in public health through better diabetes screening programs and early interventions.
        </p>

        <p>
          Ongoing research is essential to understanding the complex interplay between genetic factors and lifestyle changes in the Japanese population, paving the way for more effective personalized medicine approaches to managing Type 2 diabetes.
        </p>
        ...
        <p>
          Genetic predisposition, combined with environmental and lifestyle factors, has led to the increasing burden of Type 2 diabetes in South Korea. The country has made strides in diabetes management through national health programs and genetic research that aids in identifying high-risk individuals.
        </p>

        <p>
          Continued research into genetic factors and lifestyle interventions is crucial for controlling the rise of Type 2 diabetes in South Korea and developing effective personalized treatments.
        </p>
      </div>
    </div>
  );
